...
#route for result of finding a product by using search word
@app.route('/result')
def result():
...
#route for displaying a products found from word search
@app.route('/product/<int:id>')
def single_page(id):
    product = Addproduct.query.get_or_404(id)
    return render_template('products/single_page.html',product=product,brands=brands(),categories=categories())

#route for displaying a products with a brand
...
#route for displaying a products with a category
...
def updatebrand(id):
    ...
    return render_template('products/addbrand.html', title='Udpate brand',brands='brands',updatebrand=updatebrand)
...
def addproduct():
    ...
    if request.method=="POST"  and 'image_1' in request.files:
        ...
        addproduct = Addproduct(name=name,price=price,discount=discount,stock=stock,allergy=allergy,desc=desc,category_id=category,brand_id=brand,image_1=image_1,image_2=image_2,image_3=image_3)
...
def updateproduct(id):
    ...
    if request.method =="POST":
        ...
        product.allergy = form.allergen.data
    ...
    form.allergen.data = product.allergy
