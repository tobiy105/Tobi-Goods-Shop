...
from shop.products.views import brands, categories
import json
...
def AddCart():
    try:
        ...
        if request.method =="POST":
            DictItems = {product_id:{'name':product.name,'price':float(product.price),'discount':product.discount,'allergen':allergen,'quantity':quantity,'image':product.image_1, 'allergy':product.allergy}}
